enyo.kind({
	...
	components: [
		...
		{kind: "onyx.Button", content: "Abschicken", ontap: "send", classes: "onyx-affirmative"},
		{kind: "Panels", arrangerKind: "LeftRightArranger", fit: true, components: [
			...
			{kind: "ReportGameView", classes: "enyo-fill"},
			{}
		]}
	]
});